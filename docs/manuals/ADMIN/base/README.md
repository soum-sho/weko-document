...
図 12-1 管理者画面
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image450.png)

プロフィール設定編集画面が表示されます。

図 12-2 プロフィール設定編集画面
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image451.png)
...
![グラフィカル ユーザー インターフェイス, アプリケーション 自動的に生成された説明](media/media/image452.png)
...
画面下部にあるSAVEボタン（![iconsave](media/media/image446.png)）を押下することで、編集内容を保存できます。
