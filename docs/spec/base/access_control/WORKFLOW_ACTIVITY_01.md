...
<br>詳しくは[検索画面](ITEM_SEARCH_01.md)を参照ください。
...
インデックスへの投稿権限を利用するには、コミュニティ管理者は条件1～3の3つ、他ユーザーは条件1～2の2つを満たす必要があります。
...
条件3（コミュニティ管理者のみ） 対象が自身の管理するインデックスかどうか ※2

| 条件/ロール                      | コミュニティ<br>管理者 |
| -------------------------------- | ---------------------- |
| 　自身が管理する<br>インデックス | ○                      |
| 上記以外                         | ×                      |
...
※2 自身が管理するインデックスとは、当該コミュニティ管理者が管理するコミュニティの「Index」に指定されているインデックスとその子インデックスを指します。
