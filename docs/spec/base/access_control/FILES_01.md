...
#### ファイル公開設定：オープンアクセス / アイテム登録済みインデックスの閲覧権限有
...
#### ファイル公開設定：オープンアクセス日を指定する（指定日前） / アイテム登録済みインデックスの閲覧権限有
...
#### ファイル公開設定：ログインユーザーのみ / アイテム登録済みインデックスの閲覧権限有
...
#### ファイル公開設定：公開しない / アイテム登録済みインデックスの閲覧権限有
...
#### ファイル公開設定：公開しない「以外」 / アイテム登録済みインデックスの閲覧権限有
