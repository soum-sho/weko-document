...
| ロール       | システム<br>管理者 | リポジトリ<br>管理者 | 　 サブリポジトリ<br>管理者 | 登録ユーザー | 一般ユーザー |
| ------------ | ------------------ | -------------------- | --------------------------- | ------------ | ------------ |
| アイテム閲覧 | ○                  | ○                    | 　 ○                        | ○            | ○            |
| アイテム検索 | ○                  | ○                    | 　 ○                        | ○            | ○            |
...
| ---------------------------- | ------------------ | -------------------- | --------------------------- | ------------ | ------------ | ---------------------- |
| アイテム閲覧                 | ○                  | ○                    | 　 △(※3)                    | △(※3)        | △(※3)        | △(※3)                  |
| 添付ファイルダウンロード     | ○                  | ○                    | 　 △(※3)                    | △(※3)        | △(※3)        | △(※3)                  |
| GRDM リンクへのアクセス (※1) | ○                  | ○                    | 　 △(※3)                    | △(※3)        | △(※3)        | △(※3)                  |
| リクエストメール送信 (※2)    | ○                  | ○                    | 　 △(※3)                    | △(※3)        | △(※3)        | △(※3)                  |

※1: アイテムにプロジェクト URL が設定され、かつ関連タイプが isVersionOf の場合に GRDM ボタンが表示されます。
