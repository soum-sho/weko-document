...
sed -i 's/v1.0.7$/v1.0.7b/g' jc-niirdc-mig-rc-c.repo.nii.ac.jp/manifests/deploy-web.yaml
...
cp -iv v1_0_7a2.sql v1_0_7a2.sql.original
sed -i 's/schema/scheme/g' v1_0_7a2.sql
